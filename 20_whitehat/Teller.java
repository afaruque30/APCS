...
/*
DISCO: Be careful when setting instance variables. If you accidentally write the data type before the variable, Java thinks you are defining a new variable and not updating the old one.
QCC: Are floats very useful? It seems like in most cases doubles work fine and are more accurate.
*/
...
public class Teller {
	public static void main(String[] args){
		...
		//Also, authenticate should have a return value ("true" or "false"), so it shouldn't be a void method and the return type should be a boolean.
